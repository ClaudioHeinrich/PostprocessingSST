...
perm_test_dt_CRPS = DT[year %in% validation_years & month %in% months,.(year,month,SST_bar,SST_hat,SD_hat,SD_hat_lr_bb)]

# getting CRPSs

perm_test_dt_CRPS[,CRPS_ma := crps_na_rm(SST_bar, SST_hat,SD_hat)]
perm_test_dt_CRPS[,CRPS_lr_bb := crps_na_rm(SST_bar, SST_hat, SD_hat_lr_bb)]
