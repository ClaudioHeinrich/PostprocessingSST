...
PCs = 143       # number of considered principal components

setup_PCA(dt = DT, m = m, y = y, max_PCA_depth = 143)
...
DT_pca = fc.dt[,c("YM","SST_bar"):= DT[year %in% y & month %in% m,.(YM,SST_bar)]]
